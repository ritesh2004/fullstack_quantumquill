            ...
            <nav class="bg-[#000000] bg-opacity-20" style={{ backgroundColor: bgColor }}>
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src={logo} class="h-10 w-10 md:h-14 md:w-14 rounded-lg" alt="QuantumQuill Logo" />
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 justify-center items-center md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
                            <li className="block py-2 px-3 text-white uppercase font-bold bg-blue-700 rounded md:bg-transparent md:p-0 md:hover:text-blue-700">
                                <NavLink to={'/'}>Home</NavLink>
                            </li>
                            <li class="block py-2 px-3 text-white uppercase font-bold hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
                                <NavLink to={'/blogs'}>Posts</NavLink>
                            </li>
                            <li class="block py-2 px-3 text-white uppercase font-bold rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
                                <NavLink to={'/myblogs'}>My Posts</NavLink>
                            </li>
                            {!isAuthenticated && <li>
